...
![Product Backlog](https://github.com/DesarrolloAgil-RJAD/practica2-DAgil/blob/master/recursos/Capturas%20GithubProjects/Kanban_proyecto.PNG?raw=true "Product Backlog") 
...
> 5. Sprint 1. Historias de Usuario
   ...
   ![Sprint HU](https://github.com/DesarrolloAgil-RJAD/practica2-DAgil/blob/master/recursos/Capturas%20GithubProjects/Kanban_proyecto.PNG?raw=true "Sprint HU")
   ![Sprint Backlog](https://github.com/DesarrolloAgil-RJAD/practica2-DAgil/blob/master/recursos/Capturas%20GithubProjects/kanbansprint1.PNG?raw=true "Sprint Backlog")
   ...
   ![PBR](https://github.com/DesarrolloAgil-RJAD/practica2-DAgil/blob/master/recursos/Capturas%20GithubProjects/kanbanPBR.png?raw=true "Product Backlog Refinement")
...
![Product Backlog](https://github.com/DesarrolloAgil-RJAD/practica2-DAgil/blob/master/recursos/Capturas%20GithubProjects/kanbansprint2.PNG?raw=true "Sprint Backlog")
...
> 6.1 Sprint 2. Sprint Review.
    ...
    ¿Qué se ha hecho en este Sprint?
	    ...
	    Se ha mejorado la estructura principal de la aventura y se han implementado funcionalidades extra que nos aportaban
	    un alto valor. Hemos trabajdo en el marco SCRUM por primera vez con un exitoso resultado. Por último indicar que
	    el proyecto está disponible en la siguiente dirección web:
	    ...
	    Aquí se presenta el Sprint Planning
![Sprint Planning](https://github.com/DesarrolloAgil-RJAD/practica2-DAgil/blob/master/recursos/Capturas%20GithubProjects/tareas2.PNG?raw=true "Sprint Planning")

    Estimaciones y revisión del Product Backlog. Revisión de plazos.

	    Ha sido un poco complicado ajustarse al tiempo o a la cantidad de trabajo en la mitad final del sprint debido al surgimiento 	     de la pandemia y de los problemas que ha acarreado esta tanto en las personas como en la posibilidad de trabajo.
	...
	- Soluciones: Revisión de código por compañeros, clasificación informal de los tipos de fallos más comunes y búsquedas en la 		internet
...
> 6.2 Sprint 2. Sprint Retrospective.
...
![Sprint Retrospective](https://github.com/DesarrolloAgil-RJAD/practica2-DAgil/blob/master/recursos/Capturas%20GithubProjects/scrumreview2.PNG?raw=true "Reunión")
		
	Herramientas:
		- Desarrollo: SmartGit, NotePad++, Bloc de Notas, Brackets
		- Comunicativas: Telegram, Discord, Meet Hangouts
		- Organizativas: Kanban, Google Docs 
...
![Sprint Retrospective](https://github.com/DesarrolloAgil-RJAD/practica2-DAgil/blob/master/recursos/Capturas%20GithubProjects/excel2.PNG?raw=true "Sprint Retrospective")
...
>7. Sprint 3. Historias de Usuario
    ...
    En esta iteración se ha tomado todo el product backlog, sabiendo aún así que 
    También se ha realizado una valoración aproximada de las horas de trabajo basada en la dificultad
    estimada de las tareas derivadas de dichas historias de usuario. 
    No se han añadido las historias de usuario que se incluyeron durante el transcurso del sprint, el primer motivo era la aparición de la pandemia mundial, que afectó al ritmo de trabajo y al método en el que se afrontaba la situación. El segundo motivo era la priorización de las personas sobre procesos, quedando así un sprint con una constancia de trabajo poco uniforme.
...
> 7.2 Sprint 2. Sprint Retrospective.
